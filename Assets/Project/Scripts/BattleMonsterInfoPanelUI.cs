...
public class BattleMonsterInfoPanelUI : MonoBehaviour
{
    ...
    private static string GetMonsterEffectDisplayName(string effectId)
    {
        ...
        switch (effectId.Trim())
        {
            ...
            case "E_Knockback":
                return GameLocalization.Get("effect.knockback", "밀어냄");
            case "E_Grab":
                return GameLocalization.Get("effect.pull", "끌어당김");
            case "E_Grudge":
                return GameLocalization.Get("effect.grudge", "원한");
            case "E_Corrosion":
                return GameLocalization.Get("effect.corrosion", "침식");
            case "E_Spawn_Spider_Egg":
                return GameLocalization.Get("effect.spawn_spider_egg", "거미알 생성");
            case "E_Spawn_Spider_Web":
                return GameLocalization.Get("effect.spawn_spider_web", "거미줄 생성");
            case "E_Barrier":
                return GameLocalization.Get("effect.barrier", "장막");
            default:
