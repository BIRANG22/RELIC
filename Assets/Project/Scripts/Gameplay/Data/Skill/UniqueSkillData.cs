...
namespace Relic.Gameplay.Data
{
    [Serializable]
    /// <summary>
    /// UniqueSkillData의 책임을 담당하는 클래스입니다. 파일 상단 주석의 연결/설정 지침을 참고하세요.
    /// </summary>
    public class UniqueSkillData
    {
        ...
        public string Name;
        /// <summary>
        /// MinUseAmount: 엑셀/런타임 데이터에서 이 필드가 담아야 할 값을 저장합니다.
        /// </summary>
        public int MinUseAmount;
        /// <summary>
        /// MaxUseAmount: 엑셀/런타임 데이터에서 이 필드가 담아야 할 값을 저장합니다.
        /// </summary>
