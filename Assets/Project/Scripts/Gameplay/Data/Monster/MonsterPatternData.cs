...
namespace Relic.Gameplay.Data
{
    [Serializable]
    /// <summary>
    /// MonsterPatternData의 책임을 담당하는 클래스입니다. 파일 상단 주석의 연결/설정 지침을 참고하세요.
    /// </summary>
    public class MonsterPatternData
    {
        ...
        /// <summary>
        /// Condition: 엑셀/런타임 데이터에서 이 필드가 담아야 할 값을 저장합니다.
        /// </summary>
        public string Condition;
        /// <summary>
        /// ConditionValue: 엑셀/런타임 데이터에서 이 필드가 담아야 할 값을 저장합니다.
        /// </summary>
