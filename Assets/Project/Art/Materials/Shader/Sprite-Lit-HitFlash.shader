Shader "Dustium/2D/Sprite-Lit-HitFlash-SpriteRenderer"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        // Main URP 2D lit pass used by SpriteRenderer with a 2D Renderer.
        Pass
        {
            ...
            half4 CombinedShapeLightFragment(Varyings i) : SV_Target
            {
                ...
                // HitFlash = 0 : normal Sprite-Lit result
                // HitFlash = 1 : solid white RGB, preserving the sprite's rendered alpha.
                litColor.rgb = lerp(litColor.rgb, half3(1.0h, 1.0h, 1.0h), saturate(_HitFlash));
                litColor.a = main.a;
                return litColor;
            }
            ENDHLSL
        ...
        // Normal-map pass required by the URP 2D renderer.
        Pass
        {
        ...
        // Forward fallback used when the object is rendered outside the 2D lighting pass.
        Pass
        {
            ...
            {
                half4 mainTex = i.color * SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, i.uv);
                mainTex.rgb = lerp(mainTex.rgb, half3(1.0h, 1.0h, 1.0h), saturate(_HitFlash));
                return mainTex;
            }
            ENDHLSL
        }
